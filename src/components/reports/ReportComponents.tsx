  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="grid grid-cols-2 gap-2 md:grid-cols-4 xl:grid-cols-7">
        ...
        <MultiSelectFilter value={filters.billedBy} onChange={value => update("billedBy", value)} allLabel="Billed By: All" options={[{ value: "ITERA", label: "ITERA" }, { value: "Provider", label: "Provider" }, { value: "Unknown", label: "Not specified" }]} buttonClassName="bg-white py-1.5 text-[10px]" />
